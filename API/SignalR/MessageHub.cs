...
public class MessageHub : Hub
{
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        _uow.MessageRepository.AddMessage(message); // in order to for entity framework to track this message
    ...
    {
        var stringCompare = string.CompareOrdinal(caller, other) < 0; // rmake it a boolean value
